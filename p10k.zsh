# Generated by Powerlevel10k configuration wizard on 2024-06-14 at 21:04 JST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%45F'   # green foreground
      #上のやつのdefaultは76
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=45
  #上のやつのdefaultは76
  ...
  ####################[ java_version: java version (https://www.java.com/) ]####################
  # Java version color.
  typeset -g POWERLEVEL9K_JAVA_VERSION_FOREGROUND=160
